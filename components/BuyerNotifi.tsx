...
const BuyerNotifi: React.FC<Properties> = ({image, message, time, from, order_id, items, amount}) =>{
        ...
        <View className={`${theme == 'dark'? 'border-gray-600' : ' border-gray-300'} flex flex-row  items-center px-3 py-2`}>
            ...
            >
                ...
                <View className='flex flex-row'>
                    <View className='ml-2 grow flex justify-around'>
                        <Text
