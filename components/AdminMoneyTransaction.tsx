...
const AdminMoneyTransaction: React.FC<Properties> = ({receiver, type, amount, commission, time, status}) =>{
    ...
    return(
        ...
        >
            ...
            <View className=''>
                <Text
                className={`${theme == 'dark'? 'text-gray-400' : ' text-custom-green'} text-[9px]`}
            ...
            <View className=' flex items-end grow'>
                ...
                <View className={` ${(status == 'pending') && 'bg-yellow-500'} ${(status == 'completed') && 'bg-custom-green'} ${(status == 'failed') && 'bg-red-500'} px-2 rounded-sm`}>
                    <Text
...
export default AdminMoneyTransaction;