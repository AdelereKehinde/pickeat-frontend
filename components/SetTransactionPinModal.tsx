...
import { Text, View, StatusBar, TextInput, TouchableOpacity, ActivityIndicator, ScrollView, Modal, Pressable } from "react-native";
            ...
            <View className={`${(theme == 'dark')? "bg-gray-900" :"bg-white"} h-full`}>
                ...
                <ScrollView className='w-full' contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <Text
                        ...
                        className={`${theme == 'dark'? 'text-gray-200' : ' text-gray-700'} text-[17px] mx-4 mt-8`}
                        >
                            Transaction Pin
                    </Text>

                    <View className={`mx-4  rounded-lg  space-y-3`}>
                        <Text
                        style={{fontFamily: 'Inter-Regular'}}
                        className={`${theme == 'dark'? 'text-gray-200' : ' text-gray-700'} text-[12px]`}
                        >
                            For your security, please create a 4-digit transaction PIN.
                            You'll use this PIN to authorize important actions like sending money, updating sensitive settings, or confirming transactions.
                        </Text>
                        ...
                        className={`${theme == 'dark'? 'text-gray-200' : ' text-gray-700'} text-[12px]`}
                        >
                            Make sure to choose a PIN you can remember but isn’t easy to guess.
                    ...
                    <View className='w-full mt-10 mb-5'>
                        ...
                        <Text
                        style={{fontFamily: 'Inter-Regular'}}
                        className={`${theme == 'dark'? 'text-gray-200' : ' text-gray-700'} text-center text-[13px] tracking-tighter`}
                        >
                            Input Pin
                        </Text>
